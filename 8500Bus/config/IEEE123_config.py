...
def get_args():
    ...
    parser.add_argument("--M", type=float, default=0.005, help="negative reward coefficient")
    ...
    args.N = 10
    args.obs_dim_n = [10,10,10,10,10,10,10,10,10,10]  
    args.action_dim_n = [10,10,10,10,10,10,10,10,10,10] 
